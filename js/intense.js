...
var Intense = (function() {
    ...
    //@senntyou false: 无滑动, 1: horizontal, 2: vertical, 3: both
    ...
    function getFit( source ) {
      ...
      var heightRatio = source.h / window.innerHeight;
      var widthRatio = source.w / window.innerWidth;

      //@senntyou Added a condition of the first
      if (heightRatio > 1 && widthRatio > 1) {
        return { left: 0, top: 0, fit: 3};
      }
      else if (heightRatio <= 1 && widthRatio <= 1) {
        return { left: (window.innerWidth - source.w) / 2, top: (window.innerHeight - source.h) / 2, fit: false};
      }
      else if( widthRatio > 1 ) {
        return { left: 0, top: (window.innerHeight - source.h) / 2, fit: 1};
      } 
      else if( heightRatio > 1 )  {
        return { left: (window.innerWidth - source.w) / 2, top: 0, fit: 2 };
      }
      else {
        return { left: 0, top: 0, fit: false, both : false};
      }
    }
    ...
    function createViewer( title, caption ) {
      ...
      applyProperties( overlay, overlayProperties );
      //@senntyou end Add overlay
    ...
    function setDimensions() {
      ...
      //@senntyou
      orientation = imageDimensions.fit;
    ...
    function bindEvents() {
      ...
      //@senntyou
      overlay.addEventListener(    'click',     removeViewer,  false );
    }
    ...
    function unbindEvents() {
      ...
      //@senntyou
      overlay.removeEventListener(    'click',     removeViewer,  false );
    }
    ...
    function positionTarget() {
      ...
      if ( orientation === 3 ) {
        ...
        if( mouse.xCurr !== lastPositionX ) {
          ...
          target.style[ 'webkitTransform' ] = 'translate(' + position + 'px, ' + overflowArea.y / 2 + 'px)';
          target.style[ 'MozTransform' ] = 'translate(' + position + 'px, ' + overflowArea.y / 2 + 'px)';
          target.style[ 'msTransform' ] = 'translate(' + position + 'px, ' + overflowArea.y / 2 + 'px)';
          lastPositionX = mouse.xCurr;
        }
        ...
        if( mouse.yCurr !== lastPositionY ) {
          ...
          target.style[ 'webkitTransform' ] = 'translate( ' + overflowArea.x / 2 + 'px, ' + position + 'px)';
          target.style[ 'MozTransform' ] = 'translate( ' + overflowArea.x / 2 + 'px, ' + position + 'px)';
          target.style[ 'msTransform' ] = 'translate( ' + overflowArea.x / 2 + 'px, ' + position + 'px)';
          lastPositionY = mouse.yCurr;
        }
      }
      else {
        ...
        if( mouse.xCurr !== lastPositionX || mouse.yCurr !== lastPositionY ) {
          ...
          positionX = overflowArea.x * positionX;
          positionY = overflowArea.y * positionY;
          target.style[ 'webkitTransform' ] = 'translate(' + overflowArea.x / 2 + 'px, ' + overflowArea.y / 2 + 'px)';
          target.style[ 'MozTransform' ] = 'translate(' + overflowArea.x / 2 + 'px, ' + overflowArea.y / 2 + 'px)';
          target.style[ 'msTransform' ] = 'translate(' + overflowArea.x / 2 + 'px, ' + overflowArea.y / 2 + 'px)';
          lastPositionX = mouse.xCurr;
          lastPositionY = mouse.yCurr;
        }
      }
